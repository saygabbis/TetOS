...
export const DEFAULTS = {
  ...
  presenceMaxDailyPerUser: Number(process.env.PRESENCE_MAX_DAILY_PER_USER ?? 1),
  presenceInactiveMs: Number(process.env.PRESENCE_INACTIVE_MS ?? 3600000),
  initiationChance: Number(process.env.TETOS_INITIATION_CHANCE ?? 0.1),
